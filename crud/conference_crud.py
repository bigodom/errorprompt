...
@router.put("/conferences/{conference_id}", response_model=ConferenceCreate)
def update_conference(conference_id: int, conference: ConferenceCreate, db: Session = Depends(get_db)):
